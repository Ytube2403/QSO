...
| REQ-06 | Multi-select thủ công, hỗ trợ gắn Tags và Notes thông qua bảng (shift+click, ctrl+click) | MVP Scope | Pending |
| REQ-07 | Xử lý sanitize text khi export file CSV, XLSX (thêm `'` prefix cho `=` `+` `-` `@`) | Security | Pending |
